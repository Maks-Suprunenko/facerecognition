...
public class ChartDaily extends JFrame {
    ...
    private XYDataset createDataset() {
        ...
        try {
            ...
            connect.connection();
            connect.executeSQL("SELECT DATE_FORMAT(STR_TO_DATE(person.register_date, '%d/%m/%Y'), '%Y-%m-%d') AS register_date, COUNT(first_name) AS visita\n"
                    + "FROM person \n"
            ...
            while (connect.rs.next()) {
                int total = connect.rs.getInt("visita");
                Date data = connect.rs.getDate("register_date");
